...
ObjectReference property _DE_SmallHideTent2BR_Cuirass_PosRef auto
...
function GetRelativePositions()
	...
	myPlayerMarker_Cuirass_Pos = GetRelativePosition(_DE_SmallHideTent2BR_Tent_PosRef, _DE_SmallHideTent2BR_Cuirass_PosRef)
