...
ObjectReference property _DE_SmallLeatherTent1BR_Cuirass_PosRef auto
...
function GetRelativePositions()
	...
	myPlayerMarker_Cuirass_Pos = GetRelativePosition(_DE_SmallLeatherTent1BR_Tent_PosRef, _DE_SmallLeatherTent1BR_Cuirass_PosRef)
