scriptname CampConjuredScriptedActivator extends CampPlaceableScriptedActivatorEx
{For the placement of Campfire conjured ACTIVATOR objects. For Furniture, please use CampConjuredPlaceableObject.}
