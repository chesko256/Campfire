Scriptname _Camp_CampCrimeCellOwnerScript extends ReferenceAlias  

Actor property PlayerRef auto
Scene property _Camp_CampingCrimeTrackingCellOwnerScene auto
...
Event OnUpdate()
	debug.trace("[Campfire] Cell owner " + self.GetActorRef() + " hunting for player...")
	if self.GetActorRef().GetDistance(PlayerRef) <= 2048.0
		debug.trace("[Campfire] Found you!")
		_Camp_CampingCrimeTrackingCellOwnerScene.Start()
