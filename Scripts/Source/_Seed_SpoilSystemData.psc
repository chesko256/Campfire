...
function AddAllVanillaFood()
    ...
    cursor = PerishableFoodTable_AddRow(FoodAppleCabbageStew, FoodAppleCabbageStew_Stage2, FoodAppleCabbageStew_Stage3, FoodAppleCabbageStew_Stage4, 1, cursor)
    ...
    cursor = PerishableFoodTable_AddRow(FoodBeefStew, FoodBeefStew_Stage2, FoodBeefStew_Stage3, FoodBeefStew_Stage4, 1, cursor)
    cursor = PerishableFoodTable_AddRow(FoodBoiledCremeTreat, FoodBoiledCremeTreat_Stage2, FoodBoiledCremeTreat_Stage3, FoodBoiledCremeTreat_Stage4, 1, cursor)
    cursor = PerishableFoodTable_AddRow(FoodBread01A, FoodBread01A_Stage2, FoodBread01A_Stage3, FoodBread01A_Stage4, 1, cursor)
    cursor = PerishableFoodTable_AddRow(FoodBread01B, FoodBread01B_Stage2, FoodBread01B_Stage3, FoodBread01B_Stage4, 1, cursor)
    cursor = PerishableFoodTable_AddRow(FoodCabbage, FoodCabbage_Stage2, FoodCabbage_Stage3, FoodCabbage_Stage4, 1, cursor)
    cursor = PerishableFoodTable_AddRow(FoodCabbagePotatoSoup, FoodCabbagePotatoSoup_Stage2, FoodCabbagePotatoSoup_Stage3, FoodCabbagePotatoSoup_Stage4, 1, cursor)
    cursor = PerishableFoodTable_AddRow(FoodCabbageSoup, FoodCabbageSoup_Stage2, FoodCabbageSoup_Stage3, FoodCabbageSoup_Stage4, 1, cursor)
    cursor = PerishableFoodTable_AddRow(FoodCarrot, FoodCarrot_Stage2, FoodCarrot_Stage3, FoodCarrot_Stage4, 1, cursor)
    cursor = PerishableFoodTable_AddRow(FoodCharredSkeeverMeat, FoodCharredSkeeverMeat_Stage2, FoodCharredSkeeverMeat_Stage3, FoodCharredSkeeverMeat_Stage4, 1, cursor)
    cursor = PerishableFoodTable_AddRow(FoodCheeseWedge01, FoodCheeseWedge01_Stage2, FoodCheeseWedge01_Stage3, FoodCheeseWedge01_Stage4, 1, cursor)
    cursor = PerishableFoodTable_AddRow(FoodCheeseWedge02, FoodCheeseWedge02_Stage2, FoodCheeseWedge02_Stage3, FoodCheeseWedge02_Stage4, 1, cursor)
    cursor = PerishableFoodTable_AddRow(FoodCheeseWheel01A, FoodCheeseWheel01A_Stage2, FoodCheeseWheel01A_Stage3, FoodCheeseWheel01A_Stage4, 1, cursor)
    cursor = PerishableFoodTable_AddRow(FoodCheeseWheel01B, FoodCheeseWheel01B_Stage2, FoodCheeseWheel01B_Stage3, FoodCheeseWheel01B_Stage4, 1, cursor)
    ...
    ;cursor = PerishableFoodTable_AddRow(FoodHorseMeat, FoodHorseMeat_Stage2, FoodHorseMeat_Stage3, FoodHorseMeat_Stage4, 1, cursor)
    ;cursor = PerishableFoodTable_AddRow(FoodHorseMeatCooked, FoodHorseMeatCooked_Stage2, FoodHorseMeatCooked_Stage3, FoodHorseMeatCooked_Stage4, 1, cursor)
    ;cursor = PerishableFoodTable_AddRow(FoodLeek, FoodLeek_Stage2, FoodLeek_Stage3, FoodLeek_Stage4, 1, cursor)
    ;cursor = PerishableFoodTable_AddRow(FoodLeeksGrilled, FoodLeeksGrilled_Stage2, FoodLeeksGrilled_Stage3, FoodLeeksGrilled_Stage4, 1, cursor)
    ;cursor = PerishableFoodTable_AddRow(FoodLongTaffyTreat, FoodLongTaffyTreat_Stage2, FoodLongTaffyTreat_Stage3, FoodLongTaffyTreat_Stage4, 1, cursor)
    ;cursor = PerishableFoodTable_AddRow(FoodMammothCheeseBowl, FoodMammothCheeseBowl_Stage2, FoodMammothCheeseBowl_Stage3, FoodMammothCheeseBowl_Stage4, 1, cursor)
    ;cursor = PerishableFoodTable_AddRow(FoodMammothMeat, FoodMammothMeat_Stage2, FoodMammothMeat_Stage3, FoodMammothMeat_Stage4, 1, cursor)
    ;cursor = PerishableFoodTable_AddRow(FoodMammothMeatCooked, FoodMammothMeatCooked_Stage2, FoodMammothMeatCooked_Stage3, FoodMammothMeatCooked_Stage4, 1, cursor)
    ;cursor = PerishableFoodTable_AddRow(FoodMarriageMeal, FoodMarriageMeal_Stage2, FoodMarriageMeal_Stage3, FoodMarriageMeal_Stage4, 1, cursor)
