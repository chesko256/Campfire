...
Potion property FoodLongTaffyTreat auto
...
Potion property FoodLongTaffyTreat_Stage2 auto
...
Potion property FoodLongTaffyTreat_Stage3 auto
...
Potion property FoodLongTaffyTreat_Stage4 auto
...
function AddAllVanillaFood()
    int cursor
    cursor = PerishableFoodTable_AddRow(FoodApple, FoodApple_Stage2, FoodApple_Stage3, FoodApple_Stage4, RATE_GOES_HERE)
    ...
    cursor = PerishableFoodTable_AddRow(FoodCharredSkeeverMeat, FoodCharredSkeeverMeat_Stage2, FoodCharredSkeeverMeat_Stage3, FoodCharredSkeeverMeat_Stage4, RATE_GOES_HERE, cursor)
    cursor = PerishableFoodTable_AddRow(FoodCheeseWedge01, FoodCheeseWedge01_Stage2, FoodCheeseWedge01_Stage3, FoodCheeseWedge01_Stage4, RATE_GOES_HERE, cursor)
    cursor = PerishableFoodTable_AddRow(FoodCheeseWedge02, FoodCheeseWedge02_Stage2, FoodCheeseWedge02_Stage3, FoodCheeseWedge02_Stage4, RATE_GOES_HERE, cursor)
    cursor = PerishableFoodTable_AddRow(FoodCheeseWheel01A, FoodCheeseWheel01A_Stage2, FoodCheeseWheel01A_Stage3, FoodCheeseWheel01A_Stage4, RATE_GOES_HERE, cursor)
    ...
    cursor = PerishableFoodTable_AddRow(FoodElsweyrFondue, FoodElsweyrFondue_Stage2, FoodElsweyrFondue_Stage3, FoodElsweyrFondue_Stage4, RATE_GOES_HERE, cursor)
    cursor = PerishableFoodTable_AddRow(FoodGoatMeat, FoodGoatMeat_Stage2, FoodGoatMeat_Stage3, FoodGoatMeat_Stage4, RATE_GOES_HERE, cursor)
    cursor = PerishableFoodTable_AddRow(FoodGoatMeatCooked, FoodGoatMeatCooked_Stage2, FoodGoatMeatCooked_Stage3, FoodGoatMeatCooked_Stage4, RATE_GOES_HERE, cursor)
    cursor = PerishableFoodTable_AddRow(FoodGourd, FoodGourd_Stage2, FoodGourd_Stage3, FoodGourd_Stage4, RATE_GOES_HERE, cursor)
    cursor = PerishableFoodTable_AddRow(FoodHoney, FoodHoney_Stage2, FoodHoney_Stage3, FoodHoney_Stage4, RATE_GOES_HERE, cursor)
    cursor = PerishableFoodTable_AddRow(FoodHoneyNutTreat, FoodHoneyNutTreat_Stage2, FoodHoneyNutTreat_Stage3, FoodHoneyNutTreat_Stage4, RATE_GOES_HERE, cursor)
    cursor = PerishableFoodTable_AddRow(FoodHorkerMeat, FoodHorkerMeat_Stage2, FoodHorkerMeat_Stage3, FoodHorkerMeat_Stage4, RATE_GOES_HERE, cursor)
    cursor = PerishableFoodTable_AddRow(FoodHorkerMeatCooked, FoodHorkerMeatCooked_Stage2, FoodHorkerMeatCooked_Stage3, FoodHorkerMeatCooked_Stage4, RATE_GOES_HERE, cursor)
    cursor = PerishableFoodTable_AddRow(FoodHorkerStew, FoodHorkerStew_Stage2, FoodHorkerStew_Stage3, FoodHorkerStew_Stage4, RATE_GOES_HERE, cursor)
    cursor = PerishableFoodTable_AddRow(FoodHorseMeat, FoodHorseMeat_Stage2, FoodHorseMeat_Stage3, FoodHorseMeat_Stage4, RATE_GOES_HERE, cursor)
    cursor = PerishableFoodTable_AddRow(FoodHorseMeatCooked, FoodHorseMeatCooked_Stage2, FoodHorseMeatCooked_Stage3, FoodHorseMeatCooked_Stage4, RATE_GOES_HERE, cursor)
    cursor = PerishableFoodTable_AddRow(FoodLeek, FoodLeek_Stage2, FoodLeek_Stage3, FoodLeek_Stage4, RATE_GOES_HERE, cursor)
    cursor = PerishableFoodTable_AddRow(FoodLeeksGrilled, FoodLeeksGrilled_Stage2, FoodLeeksGrilled_Stage3, FoodLeeksGrilled_Stage4, RATE_GOES_HERE, cursor)
    cursor = PerishableFoodTable_AddRow(FoodLongTaffyTreat, FoodLongTaffyTreat_Stage2, FoodLongTaffyTreat_Stage3, FoodLongTaffyTreat_Stage4, RATE_GOES_HERE, cursor)
    cursor = PerishableFoodTable_AddRow(FoodMammothCheeseBowl, FoodMammothCheeseBowl_Stage2, FoodMammothCheeseBowl_Stage3, FoodMammothCheeseBowl_Stage4, RATE_GOES_HERE, cursor)
    ...
    cursor = PerishableFoodTable_AddRow(FoodSlaughterfishCooked, FoodSlaughterfishCooked_Stage2, FoodSlaughterfishCooked_Stage3, FoodSlaughterfishCooked_Stage4, RATE_GOES_HERE, cursor)
    cursor = PerishableFoodTable_AddRow(FoodSweetroll, FoodSweetroll_Stage2, FoodSweetroll_Stage3, FoodSweetroll_Stage4, RATE_GOES_HERE, cursor)
    cursor = PerishableFoodTable_AddRow(FoodTomato, FoodTomato_Stage2, FoodTomato_Stage3, FoodTomato_Stage4, RATE_GOES_HERE, cursor)
    cursor = PerishableFoodTable_AddRow(FoodTomatoSoup, FoodTomatoSoup_Stage2, FoodTomatoSoup_Stage3, FoodTomatoSoup_Stage4, RATE_GOES_HERE, cursor)
    cursor = PerishableFoodTable_AddRow(FoodVegetableSoup, FoodVegetableSoup_Stage2, FoodVegetableSoup_Stage3, FoodVegetableSoup_Stage4, RATE_GOES_HERE, cursor)
    cursor = PerishableFoodTable_AddRow(FoodVenison, FoodVenison_Stage2, FoodVenison_Stage3, FoodVenison_Stage4, RATE_GOES_HERE, cursor)
    cursor = PerishableFoodTable_AddRow(FoodVenisonCooked, FoodVenisonCooked_Stage2, FoodVenisonCooked_Stage3, FoodVenisonCooked_Stage4, RATE_GOES_HERE, cursor)
    cursor = PerishableFoodTable_AddRow(FoodVenisonStew, FoodVenisonStew_Stage2, FoodVenisonStew_Stage3, FoodVenisonStew_Stage4, RATE_GOES_HERE, cursor)
endFunction
