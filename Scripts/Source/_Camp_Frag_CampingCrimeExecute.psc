...
;BEGIN CODE
debug.trace("The player removed the offending items. Aborting.")
;END CODE
EndFunction
;END FRAGMENT
...
;BEGIN CODE
debug.trace("The player left the area. Aborting.")
;END CODE
EndFunction
;END FRAGMENT
...
;BEGIN CODE
debug.trace("Phase 1 start (roaming to player).")
;END CODE
EndFunction
;END FRAGMENT
...
Function Fragment_5()
;BEGIN CODE
debug.trace("The guard arrest scene began.")
;END CODE
EndFunction
;END FRAGMENT
...
Function Fragment_6()
;BEGIN CODE
debug.trace("The guard arrest scene ended.")
;END CODE
EndFunction
;END FRAGMENT
