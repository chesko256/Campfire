scriptname _DE_CampTent2_LargeLeather3BR extends _DE_Tent
...
function GetRelativePositions()
	...
	myPlayerMarker_Cuirass_Pos = GetRelativePosition(_DE_LargeLeatherTent3BR_Tent_PosRef, _Camp_LargeLeatherTent3BR_Cuirass_PosRef)
